...
export const HelpLogs: React.FC = () => {
  ...
  }, [isAdmin, helperId, doerId, status, dateFrom, dateTo, sortBy, sortDirection]);
  ...
  if (!user) return null;
  if (!isAdmin) {
    return <div className="text-slate-500">Access denied. Only Admin can view Help Logs.</div>;
  }
